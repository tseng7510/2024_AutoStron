        ...
        <div class="banner">
            <div class="container">
                <div class="box wow fadeInUp" data-wow-delay="0s">
                    <div class="banner-title banner-title2">THANK YOU <br>
                    FOR YOUR MESSAGE</div>
                </div>
            </div>
        </div>
        <section class="success-box">
            <div class="container">
                <h1 class="msg">MESSAGE HAS BEEN SUCCESSFUL!</h1>
                <div class="msg2">Once we receive your message, we will contact you as soon as possible.</div>
            </div>
        </section>
