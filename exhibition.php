...
<body>
  <div class="wrapper wrapper-content">
      ...
      <div class="container">
        <div class="box">
          <div class="text wow fadeInLeft" data-wow-delay="0s">
            <h1 class="banner-title">EXHIBITION</h1>
            <h2 class="banner-sub-title">GLOBAL PROGRESS & WORKBOOK</h2>
          </div>
        </div>
      </div>
    </div>
    <section class="sect sect1">
      <div class="container">
        <div class="pic">
          <img src="images/exhibition/pic1.png" alt="">
        </div>
        <div class="text-box wow fadeInUp" data-wow-delay="0s">
          <h3 class="sub-title">METALEX VIETNAM 2023</h3>
          <div class="text">
            https://www.metalexvietnam.com/ <br>
            Venue: Saigon Exhibition and Convention Center (SECC)<br>
            Booth No. :C24<br>
            Date: October 4-6, 2023
          </div>
          <a href="exhibition_detail.php" class="btn btn1">Learn more >></a>
        </div>
      </div>
    </section>
    <section class="sect sect2">
      <div class="container">
        <div class="ex_box">
          <img src="images/exhibition/pic2.jpg" alt="">
          <div class="text-box wow fadeInUp" data-wow-delay="0s">
            <h3 class="sub-title">TIMTOS x TMTS 2022 Machine Tool ShowMachine Tool </h3>
            <div class="text">
              https://www.timtos.com.tw/index.html <br>
              Venue: TAIPEI NANGANG Exhibition Center, Hall 2, 4F<br>
              Booth No. :4F/ R1034<br>
        ...
        <div class="ex_box">
          <img src="images/exhibition/pic3.jpg" alt="">
          <div class="text-box wow fadeInUp" data-wow-delay="0s">
            <h3 class="sub-title">2023 Taipei international Machine tool show</h3>
            <div class="text">
              https://www.timtos.com.tw/en/index.html <br>
              Venue: TAIPEI NANGANG Exhibition Center, Hall 2, 4F<br>
              Booth No.: S1024<br>
              Date: March 6-11, 2023
            </div>
            <a href="exhibition_detail.php" class="btn btn1">Learn more >></a>
          </div>
        </div>
          ...
          <div class="news-box">
            <div class="item wow fadeIn" data-wow-delay="0s">
              <div class="box">
                ...
                <a href="exhibition_detail.php" class="cover" title="The MM1552B High speed and compact through-hole rotary hydraulic cylinder" alt="The MM1552B High speed and compact through-hole rotary hydraulic cylinder">The MM1552B High speed and compact through-hole rotary hydraulic cylinder</a>
              </div>
            </div>
            <div class="item wow fadeIn" data-wow-delay="0.2s">
              <div class="box">
                ...
                <a href="exhibition_detail.php" class="cover" title="Predominating the opportunity go forward to Vietnam and overall arrangement Southeast Asian markets successfully" alt="Predominating the opportunity go forward to Vietnam and overall arrangement Southeast Asian markets successfully">Predominating the opportunity go forward to Vietnam and overall arrangement Southeast Asian markets successfully</a>
              </div>
            </div>
    ...
    <div class="breadcrumb-box">
      <div class="container">
        <ol class="breadcrumb list-inline" itemscope="" itemtype="https://schema.org/BreadcrumbList">
          ...
          <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
            <a itemprop="item" href="exhibition.php">
              <span itemprop="name">Exhibition</span></a>
