...
<body>
    <div class="wrapper wrapper-content">
        ...
        <div class="banner">
            <video class="inline-video" loop autoplay muted webkit-playsinline='true' playsinline='true'>
                <source src="https://www.apple.com/105/media/us/services/2023/4757c394-0f2b-4ec2-888b-7a24de67705c/anim/hero-sizzle/large.mp4" type="video/mp4">
            </video>
            <div class="container">
                <div class="text">
                    <div class="text_box">
            ...
            <div class="video-box">
                ...
                <div class="item">
                    <div class="box">
                        ...
                        <a href="https://www.youtube.com/watch?v=xQ1YGzERv38" 
                        class="cover fancybox-media" 
                        data-fancybox-group="thumb"
                        data-thumbnail="images/video/pic<?php echo $i%3+1?>.jpg"
                        >Forming ring precision raw claw-Chinese</a>
                    </div>
                </div>
                <?php } ?>
            </div>
