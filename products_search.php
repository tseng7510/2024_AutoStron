...
<body>
  <div class="wrapper wrapper-content productSearch">
    <?php include('include_header.php') ?>
    <div class="banner">
      <div class="container">
        <div class="box">
          <div class="text wow fadeInLeft" data-wow-delay="0s">
            <h3 class="banner-title">PRODUCTS FILTER</h3>
            <h1 class="banner-sub-title">Search Results : <span>XXXXXXXXXXXX</span> ｜ 6 items</h1>
          </div>
        </div>
      </div>
    </div>
